...
namespace eidss.openapi.web
{
    ...
    public class SoapService : ISoapService
    {
        ...
        /// <param name="value">e-Health data to transfer</param>
        ...
        /// // TODO
        /// </code></example>
        public EHealthCaseResponse CreateCase(EHealthCaseRequest value)
        {
            return call("CreateCase", value, c => EHealthCaseRequestBll.CreateCase(c), PermissionHelper.InsertPermission(EIDSSPermissionObject.HumanCase));
        }
        #endregion
