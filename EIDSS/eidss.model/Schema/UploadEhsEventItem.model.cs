...
namespace eidss.model.Schema
{
    ...
    public abstract partial class UploadEhsEventItem : 
        EditableObject<UploadEhsEventItem>
        , IObject
        , IDisposable
        , ILookupUsage
        {
        ...
        [LocalizedDisplayName(_str_idfsUploadEhsEventItem)]
        [MapField(_str_idfsUploadEhsEventItem)]
        public abstract Int64 idfsUploadEhsEventItem { get; set; }
        protected Int64 idfsUploadEhsEventItem_Original { get { return ((EditableValue<Int64>)((dynamic)this)._idfsUploadEhsEventItem).OriginalValue; } }
        protected Int64 idfsUploadEhsEventItem_Previous { get { return ((EditableValue<Int64>)((dynamic)this)._idfsUploadEhsEventItem).PreviousValue; } }
        ...
        [LocalizedDisplayName(_str_event_type)]
        [MapField(_str_event_type)]
        public abstract String event_type { get; set; }
        protected String event_type_Original { get { return ((EditableValue<String>)((dynamic)this)._event_type).OriginalValue; } }
        protected String event_type_Previous { get { return ((EditableValue<String>)((dynamic)this)._event_type).PreviousValue; } }
        ...
        [LocalizedDisplayName(_str_clinical_status_or_value)]
        [MapField(_str_clinical_status_or_value)]
        public abstract String clinical_status_or_value { get; set; }
        protected String clinical_status_or_value_Original { get { return ((EditableValue<String>)((dynamic)this)._clinical_status_or_value).OriginalValue; } }
        protected String clinical_status_or_value_Previous { get { return ((EditableValue<String>)((dynamic)this)._clinical_status_or_value).PreviousValue; } }
        ...
        [LocalizedDisplayName(_str_onset_or_issued_date)]
        [MapField(_str_onset_or_issued_date)]
        public abstract DateTime? onset_or_issued_date { get; set; }
        protected DateTime? onset_or_issued_date_Original { get { return ((EditableValue<DateTime?>)((dynamic)this)._onset_or_issued_date).OriginalValue; } }
        protected DateTime? onset_or_issued_date_Previous { get { return ((EditableValue<DateTime?>)((dynamic)this)._onset_or_issued_date).PreviousValue; } }
        ...
        [LocalizedDisplayName(_str_intResult)]
        [MapField(_str_intResult)]
        public abstract Int32 intResult { get; set; }
        protected Int32 intResult_Original { get { return ((EditableValue<Int32>)((dynamic)this)._intResult).OriginalValue; } }
        protected Int32 intResult_Previous { get { return ((EditableValue<Int32>)((dynamic)this)._intResult).PreviousValue; } }
        ...
        protected class field_info
        {
            ...
            internal Func<UploadEhsEventItem, object> _get_func;
            internal Action<UploadEhsEventItem, string> _set_func;
            internal Action<UploadEhsEventItem, UploadEhsEventItem, CompareModel, DbManagerProxy> _compare_func;
        }
        internal const string _str_Parent = "Parent";
        internal const string _str_IsNew = "IsNew";
        
        internal const string _str_idfsUploadEhs = "idfsUploadEhs";
        internal const string _str_idfsUploadEhsEventItem = "idfsUploadEhsEventItem";
        internal const string _str_patient_id = "patient_id";
        internal const string _str_event_type = "event_type";
        internal const string _str_code = "code";
        internal const string _str_clinical_status_or_value = "clinical_status_or_value";
        internal const string _str_primary_source = "primary_source";
        internal const string _str_onset_or_issued_date = "onset_or_issued_date";
        ...
        internal const string _str_intResult = "intResult";
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_idfsUploadEhsEventItem, _formname = _str_idfsUploadEhsEventItem, _type = "Int64",
              _get_func = o => o.idfsUploadEhsEventItem,
              _set_func = (o, val) => { var newval = ParsingHelper.ParseInt64(val); if (o.idfsUploadEhsEventItem != newval) o.idfsUploadEhsEventItem = newval; },
              _compare_func = (o, c, m, g) => {
                if (o.idfsUploadEhsEventItem != c.idfsUploadEhsEventItem || o.IsRIRPropChanged(_str_idfsUploadEhsEventItem, c)) 
                  m.Add(_str_idfsUploadEhsEventItem, o.ObjectIdent + _str_idfsUploadEhsEventItem, o.ObjectIdent2 + _str_idfsUploadEhsEventItem, o.ObjectIdent3 + _str_idfsUploadEhsEventItem, "Int64", 
                    o.idfsUploadEhsEventItem == null ? "" : o.idfsUploadEhsEventItem.ToString(),                  
                  o.IsReadOnly(_str_idfsUploadEhsEventItem), o.IsInvisible(_str_idfsUploadEhsEventItem), o.IsRequired(_str_idfsUploadEhsEventItem)); 
                  }
              }, 
            ...
            new field_info {
              _name = _str_event_type, _formname = _str_event_type, _type = "String",
              _get_func = o => o.event_type,
              _set_func = (o, val) => { var newval = ParsingHelper.ParseString(val); if (o.event_type != newval) o.event_type = newval; },
              _compare_func = (o, c, m, g) => {
                if (o.event_type != c.event_type || o.IsRIRPropChanged(_str_event_type, c)) 
                  m.Add(_str_event_type, o.ObjectIdent + _str_event_type, o.ObjectIdent2 + _str_event_type, o.ObjectIdent3 + _str_event_type, "String", 
                    o.event_type == null ? "" : o.event_type.ToString(),                  
                  o.IsReadOnly(_str_event_type), o.IsInvisible(_str_event_type), o.IsRequired(_str_event_type)); 
                  }
              }, 
            ...
            new field_info {
              _name = _str_clinical_status_or_value, _formname = _str_clinical_status_or_value, _type = "String",
              _get_func = o => o.clinical_status_or_value,
              _set_func = (o, val) => { var newval = ParsingHelper.ParseString(val); if (o.clinical_status_or_value != newval) o.clinical_status_or_value = newval; },
              _compare_func = (o, c, m, g) => {
                if (o.clinical_status_or_value != c.clinical_status_or_value || o.IsRIRPropChanged(_str_clinical_status_or_value, c)) 
                  m.Add(_str_clinical_status_or_value, o.ObjectIdent + _str_clinical_status_or_value, o.ObjectIdent2 + _str_clinical_status_or_value, o.ObjectIdent3 + _str_clinical_status_or_value, "String", 
                    o.clinical_status_or_value == null ? "" : o.clinical_status_or_value.ToString(),                  
                  o.IsReadOnly(_str_clinical_status_or_value), o.IsInvisible(_str_clinical_status_or_value), o.IsRequired(_str_clinical_status_or_value)); 
                  }
              }, 
            ...
            new field_info {
              _name = _str_onset_or_issued_date, _formname = _str_onset_or_issued_date, _type = "DateTime?",
              _get_func = o => o.onset_or_issued_date,
              _set_func = (o, val) => { var newval = ParsingHelper.ParseDateTimeNullable(val); if (o.onset_or_issued_date != newval) o.onset_or_issued_date = newval; },
              _compare_func = (o, c, m, g) => {
                if (o.onset_or_issued_date != c.onset_or_issued_date || o.IsRIRPropChanged(_str_onset_or_issued_date, c)) 
                  m.Add(_str_onset_or_issued_date, o.ObjectIdent + _str_onset_or_issued_date, o.ObjectIdent2 + _str_onset_or_issued_date, o.ObjectIdent3 + _str_onset_or_issued_date, "DateTime?", 
                    o.onset_or_issued_date == null ? "" : o.onset_or_issued_date.ToString(),                  
                  o.IsReadOnly(_str_onset_or_issued_date), o.IsInvisible(_str_onset_or_issued_date), o.IsRequired(_str_onset_or_issued_date)); 
                  }
              }, 
            ...
            new field_info {
              _name = _str_intResult, _formname = _str_intResult, _type = "Int32",
              _get_func = o => o.intResult,
              _set_func = (o, val) => { var newval = ParsingHelper.ParseInt32(val); if (o.intResult != newval) o.intResult = newval; },
              _compare_func = (o, c, m, g) => {
                if (o.intResult != c.intResult || o.IsRIRPropChanged(_str_intResult, c)) 
                  m.Add(_str_intResult, o.ObjectIdent + _str_intResult, o.ObjectIdent2 + _str_intResult, o.ObjectIdent3 + _str_intResult, "Int32", 
                    o.intResult == null ? "" : o.intResult.ToString(),                  
                  o.IsReadOnly(_str_intResult), o.IsInvisible(_str_intResult), o.IsRequired(_str_intResult)); 
                  }
              }, 
        ...
        internal CompareModel _compare(IObject o, CompareModel ret)
        {
            ...
            UploadEhsEventItem obj = (UploadEhsEventItem)o;
        ...
        {
            get { return new Func<UploadEhsEventItem, UploadEhsMaster>(c => c.Parent as UploadEhsMaster)(this); }
        ...
        public bool isValid
        {
            get { return new Func<UploadEhsEventItem, bool>(c => c.validationErrors == null || c.validationErrors.Count == 0)(this); }
        ...
        internal string m_ObjectName = "UploadEhsEventItem";
        ...
        {
            var ret = base.Clone() as UploadEhsEventItem;
            ret.bIsClone = true;
            ret.Cloned();
        ...
        public UploadEhsEventItem CloneWithSetup()
        {
            using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
            {
                return CloneWithSetup(manager) as UploadEhsEventItem;
            }
        }
        #endregion
        ...
        private bool IsRIRPropChanged(string fld, UploadEhsEventItem c)
        {
            return IsReadOnly(fld) != c.IsReadOnly(fld) || IsInvisible(fld) != c.IsInvisible(fld) || IsRequired(fld) != c._isRequired(m_isRequired, fld);
        }
        private bool IsLookupContentChanged(DbManagerProxy manager, string fld, UploadEhsEventItem c)
        {
        ...
        {
            PropertyChanged += new System.ComponentModel.PropertyChangedEventHandler(UploadEhsEventItem_PropertyChanged);
        }
        public void _RevokeMainHandler()
        {
            PropertyChanged -= new System.ComponentModel.PropertyChangedEventHandler(UploadEhsEventItem_PropertyChanged);
        }
        private void UploadEhsEventItem_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            (sender as UploadEhsEventItem).Changed(e.PropertyName);
        ...
        internal Dictionary<string, Func<UploadEhsEventItem, bool>> m_isRequired;
        private bool _isRequired(Dictionary<string, Func<UploadEhsEventItem, bool>> isRequiredDict, string name)
        {
        ...
        public void AddRequired(string name, Func<UploadEhsEventItem, bool> func)
        {
            if (m_isRequired == null) 
                m_isRequired = new Dictionary<string, Func<UploadEhsEventItem, bool>>();
            if (!m_isRequired.ContainsKey(name))
                m_isRequired.Add(name, func);
        }
    
    internal Dictionary<string, Func<UploadEhsEventItem, bool>> m_isHiddenPersonalData;
    ...
    public void AddHiddenPersonalData(string name, Func<UploadEhsEventItem, bool> func)
    {
      if (m_isHiddenPersonalData == null)
        m_isHiddenPersonalData = new Dictionary<string, Func<UploadEhsEventItem, bool>>();
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        : DataAccessor<UploadEhsEventItem>
            , IObjectAccessor
            , IObjectMeta
            , IObjectValidator
            
            , IObjectCreator
            , IObjectCreator<UploadEhsEventItem>
                ...
                
        {
            ...
            public delegate void on_action(UploadEhsEventItem obj);
            ...
            public virtual List<UploadEhsEventItem> SelectList(DbManagerProxy manager
                )
            {
                return _SelectList(manager
                    , delegate(UploadEhsEventItem obj)
                        {
                        }
                    , delegate(UploadEhsEventItem obj)
                        {
            ...
            public List<UploadEhsEventItem> _SelectList(DbManagerProxy manager
            ...
            public virtual List<UploadEhsEventItem> _SelectListInternal(DbManagerProxy manager
                , on_action loading, on_action loaded
                )
            {
                UploadEhsEventItem _obj = null;
                try
                {
                    MapResultSet[] sets = new MapResultSet[1];
                    List<UploadEhsEventItem> objs = new List<UploadEhsEventItem>();
                    sets[0] = new MapResultSet(typeof(UploadEhsEventItem), objs);
                    
                    manager
                        .SetSpCommand("spUploadEhsEventItem_SelectDetail"
                            )
            ...
            internal void _SetupLoad(DbManagerProxy manager, UploadEhsEventItem obj, bool bCloning = false)
            {
                if (obj == null) return;
            ...
            internal void _SetPermitions(IObjectPermissions permissions, UploadEhsEventItem obj)
            {
                if (obj != null)
                {
            ...
            private UploadEhsEventItem _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                UploadEhsEventItem obj = null;
                try
                {
                    obj = UploadEhsEventItem.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
                ...
                obj.idfsUploadEhs = new Func<UploadEhsEventItem, long>(c => c.master == null ? 0 : c.master.idfsUploadEhs)(obj);
                obj.idfsUploadEhsEventItem = (new PositiveAutoIncrementExtender<UploadEhsEventItem>()).GetScalar(manager, obj, isFake);
            ...
            public UploadEhsEventItem CreateNewT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public UploadEhsEventItem CreateFakeT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public UploadEhsEventItem CreateWithParamsT(DbManagerProxy manager, IObject Parent, List<object> pars)
            {
            ...
            private void _SetupChildHandlers(UploadEhsEventItem obj, object newobj)
            {
                
            }
            
            private void _SetupHandlers(UploadEhsEventItem obj)
            {
                
            }
    

            internal void _LoadLookups(DbManagerProxy manager, UploadEhsEventItem obj)
            {
                
            }
    
            [SprocName("spUploadEhsEventItem_Post")]
            protected abstract void _post(DbManagerProxy manager, 
                [Direction.InputOutput("idfCase")] UploadEhsEventItem obj);
            protected void _postPredicate(DbManagerProxy manager, 
                [Direction.InputOutput("idfCase")] UploadEhsEventItem obj)
            {
                
                if (new Func<UploadEhsEventItem, bool>(c => c.isValid)(obj))
                {
            ...
            public bool Post(DbManagerProxy manager, IObject obj, bool bChildObject = false)
            {
                ...
                for (int iAttemptNumber = 0; iAttemptNumber < iDeadlockAttemptsCount; iAttemptNumber++)
                {
                    ...
                    try
                    {
                        UploadEhsEventItem bo = obj as UploadEhsEventItem;
                        ...
                        bSuccess = _PostNonTransaction(manager, obj as UploadEhsEventItem, bChildObject);
            ...
            private bool _PostNonTransaction(DbManagerProxy manager, UploadEhsEventItem obj, bool bChildObject) 
            { 
            ...
            public bool ValidateCanDelete(UploadEhsEventItem obj)
            {
                using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
                {
            ...
            public bool ValidateCanDelete(DbManagerProxy manager, UploadEhsEventItem obj)
            {
            ...
            protected ValidationModelException ChainsValidate(UploadEhsEventItem obj)
            {
                
                return null;
            }
            protected bool ChainsValidate(UploadEhsEventItem obj, bool bRethrowException)
            {
            ...
            {
                return Validate(manager, obj as UploadEhsEventItem, bPostValidation, bChangeValidation, bDeepValidation, bRethrowException);
            }
            public bool Validate(DbManagerProxy manager, UploadEhsEventItem obj, bool bPostValidation, bool bChangeValidation, bool bDeepValidation, bool bRethrowException = false)
            {
            ...
            private void _SetupRequired(UploadEhsEventItem obj)
            {
            
            }
    
    private void _SetupPersonalDataRestrictions(UploadEhsEventItem obj)
    {
            ...
            public bool RequiredByField(string name, IObject obj) { return Meta.RequiredByField.ContainsKey(name) ? Meta.RequiredByField[name](obj as UploadEhsEventItem) : false; }
            public bool RequiredByProperty(string name, IObject obj) { return Meta.RequiredByProperty.ContainsKey(name) ? Meta.RequiredByProperty[name](obj as UploadEhsEventItem) : false; }
            public List<SearchPanelMetaItem> SearchPanelMeta { get { return Meta.SearchPanelMeta; } }
            public List<GridMetaItem> GridMeta { get { return Meta.GridMeta; } }
            public List<ActionMetaItem> Actions { get { return Meta.Actions; } }
            public string DetailPanel { get { return "UploadEhsEventItemDetail"; } }
        ...
        {
            public static string spSelect = "spUploadEhsEventItem_SelectDetail";
            public static string spCount = "";
            public static string spPost = "spUploadEhsEventItem_Post";
            ...
            public static Dictionary<string, Func<UploadEhsEventItem, bool>> RequiredByField = new Dictionary<string, Func<UploadEhsEventItem, bool>>();
            public static Dictionary<string, Func<UploadEhsEventItem, bool>> RequiredByProperty = new Dictionary<string, Func<UploadEhsEventItem, bool>>();
    ...
    private static void AddHiddenPersonalData(string name, Func<bool> func)
    {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                Sizes.Add(_str_event_type, 100);
                Sizes.Add(_str_code, 100);
                Sizes.Add(_str_clinical_status_or_value, 200);
