...
namespace eidss.model.Schema
{
    ...
    public abstract partial class UploadEhsClinicalEventItem : 
        EditableObject<UploadEhsClinicalEventItem>
        , IObject
        , IDisposable
        , ILookupUsage
        {
        ...
        [LocalizedDisplayName(_str_idfsUploadEhsClinicalEventItem)]
        [MapField(_str_idfsUploadEhsClinicalEventItem)]
        public abstract Int64 idfsUploadEhsClinicalEventItem { get; set; }
        protected Int64 idfsUploadEhsClinicalEventItem_Original { get { return ((EditableValue<Int64>)((dynamic)this)._idfsUploadEhsClinicalEventItem).OriginalValue; } }
        protected Int64 idfsUploadEhsClinicalEventItem_Previous { get { return ((EditableValue<Int64>)((dynamic)this)._idfsUploadEhsClinicalEventItem).PreviousValue; } }
        ...
        [LocalizedDisplayName(_str_clinical_status)]
        [MapField(_str_clinical_status)]
        public abstract String clinical_status { get; set; }
        protected String clinical_status_Original { get { return ((EditableValue<String>)((dynamic)this)._clinical_status).OriginalValue; } }
        protected String clinical_status_Previous { get { return ((EditableValue<String>)((dynamic)this)._clinical_status).PreviousValue; } }
        ...
        [LocalizedDisplayName(_str_onset_date)]
        [MapField(_str_onset_date)]
        public abstract DateTime? onset_date { get; set; }
        protected DateTime? onset_date_Original { get { return ((EditableValue<DateTime?>)((dynamic)this)._onset_date).OriginalValue; } }
        protected DateTime? onset_date_Previous { get { return ((EditableValue<DateTime?>)((dynamic)this)._onset_date).PreviousValue; } }
        ...
        protected class field_info
        {
            ...
            internal Func<UploadEhsClinicalEventItem, object> _get_func;
            internal Action<UploadEhsClinicalEventItem, string> _set_func;
            internal Action<UploadEhsClinicalEventItem, UploadEhsClinicalEventItem, CompareModel, DbManagerProxy> _compare_func;
        }
        internal const string _str_Parent = "Parent";
        internal const string _str_IsNew = "IsNew";
        
        internal const string _str_idfsUploadEhs = "idfsUploadEhs";
        internal const string _str_idfsUploadEhsClinicalEventItem = "idfsUploadEhsClinicalEventItem";
        internal const string _str_patient_id = "patient_id";
        internal const string _str_code = "code";
        internal const string _str_clinical_status = "clinical_status";
        internal const string _str_primary_source = "primary_source";
        internal const string _str_onset_date = "onset_date";
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_idfsUploadEhsClinicalEventItem, _formname = _str_idfsUploadEhsClinicalEventItem, _type = "Int64",
              _get_func = o => o.idfsUploadEhsClinicalEventItem,
              _set_func = (o, val) => { var newval = ParsingHelper.ParseInt64(val); if (o.idfsUploadEhsClinicalEventItem != newval) o.idfsUploadEhsClinicalEventItem = newval; },
              _compare_func = (o, c, m, g) => {
                if (o.idfsUploadEhsClinicalEventItem != c.idfsUploadEhsClinicalEventItem || o.IsRIRPropChanged(_str_idfsUploadEhsClinicalEventItem, c)) 
                  m.Add(_str_idfsUploadEhsClinicalEventItem, o.ObjectIdent + _str_idfsUploadEhsClinicalEventItem, o.ObjectIdent2 + _str_idfsUploadEhsClinicalEventItem, o.ObjectIdent3 + _str_idfsUploadEhsClinicalEventItem, "Int64", 
                    o.idfsUploadEhsClinicalEventItem == null ? "" : o.idfsUploadEhsClinicalEventItem.ToString(),                  
                  o.IsReadOnly(_str_idfsUploadEhsClinicalEventItem), o.IsInvisible(_str_idfsUploadEhsClinicalEventItem), o.IsRequired(_str_idfsUploadEhsClinicalEventItem)); 
                  }
              }, 
            ...
            new field_info {
              _name = _str_clinical_status, _formname = _str_clinical_status, _type = "String",
              _get_func = o => o.clinical_status,
              _set_func = (o, val) => { var newval = ParsingHelper.ParseString(val); if (o.clinical_status != newval) o.clinical_status = newval; },
              _compare_func = (o, c, m, g) => {
                if (o.clinical_status != c.clinical_status || o.IsRIRPropChanged(_str_clinical_status, c)) 
                  m.Add(_str_clinical_status, o.ObjectIdent + _str_clinical_status, o.ObjectIdent2 + _str_clinical_status, o.ObjectIdent3 + _str_clinical_status, "String", 
                    o.clinical_status == null ? "" : o.clinical_status.ToString(),                  
                  o.IsReadOnly(_str_clinical_status), o.IsInvisible(_str_clinical_status), o.IsRequired(_str_clinical_status)); 
                  }
              }, 
            ...
            new field_info {
              _name = _str_onset_date, _formname = _str_onset_date, _type = "DateTime?",
              _get_func = o => o.onset_date,
              _set_func = (o, val) => { var newval = ParsingHelper.ParseDateTimeNullable(val); if (o.onset_date != newval) o.onset_date = newval; },
              _compare_func = (o, c, m, g) => {
                if (o.onset_date != c.onset_date || o.IsRIRPropChanged(_str_onset_date, c)) 
                  m.Add(_str_onset_date, o.ObjectIdent + _str_onset_date, o.ObjectIdent2 + _str_onset_date, o.ObjectIdent3 + _str_onset_date, "DateTime?", 
                    o.onset_date == null ? "" : o.onset_date.ToString(),                  
                  o.IsReadOnly(_str_onset_date), o.IsInvisible(_str_onset_date), o.IsRequired(_str_onset_date)); 
                  }
              }, 
        ...
        internal CompareModel _compare(IObject o, CompareModel ret)
        {
            ...
            UploadEhsClinicalEventItem obj = (UploadEhsClinicalEventItem)o;
        ...
        {
            get { return new Func<UploadEhsClinicalEventItem, UploadEhsMaster>(c => c.Parent as UploadEhsMaster)(this); }
        ...
        public bool isValid
        {
            get { return new Func<UploadEhsClinicalEventItem, bool>(c => c.validationErrors == null || c.validationErrors.Count == 0)(this); }
        ...
        internal string m_ObjectName = "UploadEhsClinicalEventItem";
        ...
        {
            var ret = base.Clone() as UploadEhsClinicalEventItem;
            ret.bIsClone = true;
            ret.Cloned();
        ...
        public UploadEhsClinicalEventItem CloneWithSetup()
        {
            using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
            {
                return CloneWithSetup(manager) as UploadEhsClinicalEventItem;
            }
        }
        #endregion
        ...
        private bool IsRIRPropChanged(string fld, UploadEhsClinicalEventItem c)
        {
            return IsReadOnly(fld) != c.IsReadOnly(fld) || IsInvisible(fld) != c.IsInvisible(fld) || IsRequired(fld) != c._isRequired(m_isRequired, fld);
        }
        private bool IsLookupContentChanged(DbManagerProxy manager, string fld, UploadEhsClinicalEventItem c)
        {
        ...
        public UploadEhsClinicalEventItem()
        {
        ...
        {
            PropertyChanged += new System.ComponentModel.PropertyChangedEventHandler(UploadEhsClinicalEventItem_PropertyChanged);
        }
        public void _RevokeMainHandler()
        {
            PropertyChanged -= new System.ComponentModel.PropertyChangedEventHandler(UploadEhsClinicalEventItem_PropertyChanged);
        }
        private void UploadEhsClinicalEventItem_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            (sender as UploadEhsClinicalEventItem).Changed(e.PropertyName);
        ...
        {
            UploadEhsClinicalEventItem obj = this;
        ...
        internal Dictionary<string, Func<UploadEhsClinicalEventItem, bool>> m_isRequired;
        private bool _isRequired(Dictionary<string, Func<UploadEhsClinicalEventItem, bool>> isRequiredDict, string name)
        {
        ...
        public void AddRequired(string name, Func<UploadEhsClinicalEventItem, bool> func)
        {
            if (m_isRequired == null) 
                m_isRequired = new Dictionary<string, Func<UploadEhsClinicalEventItem, bool>>();
            if (!m_isRequired.ContainsKey(name))
                m_isRequired.Add(name, func);
        }
    
    internal Dictionary<string, Func<UploadEhsClinicalEventItem, bool>> m_isHiddenPersonalData;
    ...
    public void AddHiddenPersonalData(string name, Func<UploadEhsClinicalEventItem, bool> func)
    {
      if (m_isHiddenPersonalData == null)
        m_isHiddenPersonalData = new Dictionary<string, Func<UploadEhsClinicalEventItem, bool>>();
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        : DataAccessor<UploadEhsClinicalEventItem>
            , IObjectAccessor
            , IObjectMeta
            , IObjectValidator
            
            , IObjectCreator
            , IObjectCreator<UploadEhsClinicalEventItem>
                ...
                
        {
            ...
            public delegate void on_action(UploadEhsClinicalEventItem obj);
            ...
            public virtual List<UploadEhsClinicalEventItem> SelectList(DbManagerProxy manager
                )
            {
                return _SelectList(manager
                    , delegate(UploadEhsClinicalEventItem obj)
                        {
                        }
                    , delegate(UploadEhsClinicalEventItem obj)
                        {
            ...
            public List<UploadEhsClinicalEventItem> _SelectList(DbManagerProxy manager
            ...
            public virtual List<UploadEhsClinicalEventItem> _SelectListInternal(DbManagerProxy manager
                , on_action loading, on_action loaded
                )
            {
                UploadEhsClinicalEventItem _obj = null;
                try
                {
                    MapResultSet[] sets = new MapResultSet[1];
                    List<UploadEhsClinicalEventItem> objs = new List<UploadEhsClinicalEventItem>();
                    sets[0] = new MapResultSet(typeof(UploadEhsClinicalEventItem), objs);
                    
                    manager
                        .SetSpCommand("spUploadEhsClinicalEventItem_SelectDetail"
                            )
            ...
            internal void _SetupLoad(DbManagerProxy manager, UploadEhsClinicalEventItem obj, bool bCloning = false)
            {
                if (obj == null) return;
            ...
            internal void _SetPermitions(IObjectPermissions permissions, UploadEhsClinicalEventItem obj)
            {
                if (obj != null)
                {
            ...
            private UploadEhsClinicalEventItem _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                UploadEhsClinicalEventItem obj = null;
                try
                {
                    obj = UploadEhsClinicalEventItem.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
                ...
                obj.idfsUploadEhs = new Func<UploadEhsClinicalEventItem, long>(c => c.master == null ? 0 : c.master.idfsUploadEhs)(obj);
                obj.idfsUploadEhsClinicalEventItem = (new PositiveAutoIncrementExtender<UploadEhsClinicalEventItem>()).GetScalar(manager, obj, isFake);
            ...
            public UploadEhsClinicalEventItem CreateNewT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public UploadEhsClinicalEventItem CreateFakeT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public UploadEhsClinicalEventItem CreateWithParamsT(DbManagerProxy manager, IObject Parent, List<object> pars)
            {
            ...
            private void _SetupChildHandlers(UploadEhsClinicalEventItem obj, object newobj)
            {
                
            }
            
            private void _SetupHandlers(UploadEhsClinicalEventItem obj)
            {
                
            }
    

            internal void _LoadLookups(DbManagerProxy manager, UploadEhsClinicalEventItem obj)
            {
                
            }
    
            [SprocName("spUploadEhsClinicalEventItem_Post")]
            protected abstract void _post(DbManagerProxy manager, 
                [Direction.InputOutput()] UploadEhsClinicalEventItem obj);
            protected void _postPredicate(DbManagerProxy manager, 
                [Direction.InputOutput()] UploadEhsClinicalEventItem obj)
            {
                
                if (new Func<UploadEhsClinicalEventItem, bool>(c => c.isValid)(obj))
                {
            ...
            public bool Post(DbManagerProxy manager, IObject obj, bool bChildObject = false)
            {
                ...
                for (int iAttemptNumber = 0; iAttemptNumber < iDeadlockAttemptsCount; iAttemptNumber++)
                {
                    ...
                    try
                    {
                        UploadEhsClinicalEventItem bo = obj as UploadEhsClinicalEventItem;
                        ...
                        bSuccess = _PostNonTransaction(manager, obj as UploadEhsClinicalEventItem, bChildObject);
            ...
            private bool _PostNonTransaction(DbManagerProxy manager, UploadEhsClinicalEventItem obj, bool bChildObject) 
            { 
            ...
            public bool ValidateCanDelete(UploadEhsClinicalEventItem obj)
            {
                using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
                {
            ...
            public bool ValidateCanDelete(DbManagerProxy manager, UploadEhsClinicalEventItem obj)
            {
            ...
            protected ValidationModelException ChainsValidate(UploadEhsClinicalEventItem obj)
            {
                
                return null;
            }
            protected bool ChainsValidate(UploadEhsClinicalEventItem obj, bool bRethrowException)
            {
            ...
            {
                return Validate(manager, obj as UploadEhsClinicalEventItem, bPostValidation, bChangeValidation, bDeepValidation, bRethrowException);
            }
            public bool Validate(DbManagerProxy manager, UploadEhsClinicalEventItem obj, bool bPostValidation, bool bChangeValidation, bool bDeepValidation, bool bRethrowException = false)
            {
            ...
            private void _SetupRequired(UploadEhsClinicalEventItem obj)
            {
            
            }
    
    private void _SetupPersonalDataRestrictions(UploadEhsClinicalEventItem obj)
    {
            ...
            public bool RequiredByField(string name, IObject obj) { return Meta.RequiredByField.ContainsKey(name) ? Meta.RequiredByField[name](obj as UploadEhsClinicalEventItem) : false; }
            public bool RequiredByProperty(string name, IObject obj) { return Meta.RequiredByProperty.ContainsKey(name) ? Meta.RequiredByProperty[name](obj as UploadEhsClinicalEventItem) : false; }
            public List<SearchPanelMetaItem> SearchPanelMeta { get { return Meta.SearchPanelMeta; } }
            public List<GridMetaItem> GridMeta { get { return Meta.GridMeta; } }
            public List<ActionMetaItem> Actions { get { return Meta.Actions; } }
            public string DetailPanel { get { return "UploadEhsClinicalEventItemDetail"; } }
        ...
        {
            public static string spSelect = "spUploadEhsClinicalEventItem_SelectDetail";
            public static string spCount = "";
            public static string spPost = "spUploadEhsClinicalEventItem_Post";
            ...
            public static Dictionary<string, Func<UploadEhsClinicalEventItem, bool>> RequiredByField = new Dictionary<string, Func<UploadEhsClinicalEventItem, bool>>();
            public static Dictionary<string, Func<UploadEhsClinicalEventItem, bool>> RequiredByProperty = new Dictionary<string, Func<UploadEhsClinicalEventItem, bool>>();
    ...
    private static void AddHiddenPersonalData(string name, Func<bool> func)
    {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                Sizes.Add(_str_clinical_status, 200);
