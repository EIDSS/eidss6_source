...
namespace eidss.model.Schema
{
    ...
    public abstract partial class Person : 
        ...
        [LocalizedDisplayName("Person.strContactPhone")]
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                    ...
                    
        {
            ...
            public bool Validate(DbManagerProxy manager, Person obj, bool bPostValidation, bool bChangeValidation, bool bDeepValidation, bool bRethrowException = false)
            {
                ...
                (new RequiredValidator( "strContactPhone", "strContactPhone","Person.strContactPhone",
                ValidationEventType.Error
              )).Validate(c => c.idfsOrganizationSite.HasValue && eidss.model.Core.EidssUserContext.User.HasPermission(PermissionHelper.SelectPermission(EIDSSPermissionObject.User)) && (c.LoginInfoList != null) && (c.LoginInfoList.Count(i => !i.IsMarkedToDelete) > 0) && eidss.model.Core.EidssSiteContext.Instance.IsKazakhstanMoHCustomization, obj, obj.strContactPhone);
            ...
            private void _SetupRequired(Person obj)
            {
                ...
                obj
                    .AddRequired("strContactPhone", c => c.idfsOrganizationSite.HasValue && eidss.model.Core.EidssUserContext.User.HasPermission(PermissionHelper.SelectPermission(EIDSSPermissionObject.User)) && (c.LoginInfoList != null) && (c.LoginInfoList.Count(i => !i.IsMarkedToDelete) > 0) && eidss.model.Core.EidssSiteContext.Instance.IsKazakhstanMoHCustomization);
    ...
    private static void AddHiddenPersonalData(string name, Func<bool> func)
    {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                if (!RequiredByField.ContainsKey("strContactPhone")) RequiredByField.Add("strContactPhone", c => c.idfsOrganizationSite.HasValue && eidss.model.Core.EidssUserContext.User.HasPermission(PermissionHelper.SelectPermission(EIDSSPermissionObject.User)) && (c.LoginInfoList != null) && (c.LoginInfoList.Count(i => !i.IsMarkedToDelete) > 0) && eidss.model.Core.EidssSiteContext.Instance.IsKazakhstanMoHCustomization);
                if (!RequiredByProperty.ContainsKey("strContactPhone")) RequiredByProperty.Add("strContactPhone", c => c.idfsOrganizationSite.HasValue && eidss.model.Core.EidssUserContext.User.HasPermission(PermissionHelper.SelectPermission(EIDSSPermissionObject.User)) && (c.LoginInfoList != null) && (c.LoginInfoList.Count(i => !i.IsMarkedToDelete) > 0) && eidss.model.Core.EidssSiteContext.Instance.IsKazakhstanMoHCustomization);
