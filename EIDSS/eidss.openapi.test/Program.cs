    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                client.Login(new Login() { organization = "test_org", user = "test_user", password = "test", language = "en", externalSystem = "e-TB" });
            ...
            //handler.Credentials = new NetworkCredential("test_org@test_admin@en", "test");

            /*
            var organization = "test_org";
