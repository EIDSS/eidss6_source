...
namespace eidss.model.Core
{
    ...
    public class EidssUser : IIdentity, IUser
    {
        ...
        private string m_EmployeeTaxId;

        public string EmployeeTaxId
        {
            get { return m_EmployeeTaxId; }
            set { m_EmployeeTaxId = value; }
        }


        private string m_EmployerFacilityTaxId;

        public string EmployerFacilityTaxId
        {
            get { return m_EmployerFacilityTaxId; }
            set { m_EmployerFacilityTaxId = value; }
        }


        private bool m_AuthorizationEds = false;

        public bool AuthorizationEds
        {
            get { return m_AuthorizationEds; }
            set { m_AuthorizationEds = value; }
        }


        private bool m_SavingEds = false;

        public bool SavingEds
        {
            get { return m_SavingEds; }
            set { m_SavingEds = value; }
        }

        private string m_LoginPendingEdsTicket;

        public string LoginPendingEdsTicket
        {
            get { return m_LoginPendingEdsTicket; }
            set { m_LoginPendingEdsTicket = value; }
        }
        ...
        public void Clear()
        {
            ...
            EmployeeTaxId = null;
            EmployerFacilityTaxId = null;
            AuthorizationEds = false;
            SavingEds = false;
            LoginPendingEdsTicket = null;
        }
