    ...
    namespace eidss.winclient.Schema
    {
      ...
      public partial class BaseListPanel_PendingEdsEventListItem : BaseListPanel<PendingEdsEventListItem>
      {
      
        public BaseListPanel_PendingEdsEventListItem() : base()
        {
          FormID = "S20";
        }
      ...
      public partial class BaseDetailPanel_PendingEds : BaseDetailPanel<PendingEds>
      {
      
        public BaseDetailPanel_PendingEds() : base()
        {
          m_RelatedLists = new string[]{"PendingEdsListItem"};
