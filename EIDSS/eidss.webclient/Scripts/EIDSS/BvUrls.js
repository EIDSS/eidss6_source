var bvUrls = (function () {
    ...
    var paths = {
        ...
        isSessionDisconnectionEnabled: "/Account/IsSessionDisconnectionEnabled",
        isDisconnected: "/Account/IsDisconnected",
        isPossibleToLogin: "/Account/IsPossibleToLogin",
        loginInternal: "/Account/LoginInternal",
        validateSecurityPolicy: "/Account/ValidateSecurityPolicy",
        infoForSignPendingEds: "/PendingJournal/InfoForSignPendingEds/",
        checkEds: "/Account/CheckEds",
        edsCanceled: "/Account/ReflectCancelEdsEventToSecurityLog",
        edsExceededAttempts: "/Account/ReflectExceededAttemptsEdsEventToSecurityLog",
        edsNCALayerClosed: "/Account/ReflectNCALayerErrorEdsEventToSecurityLog",
        ...
        disconnectAllSessions: "/Account/DisconnectSessions"
    };
    ...
    return {
        ...
        getIsDisconnectedUrl: function (params){
            return bvUrls.buildUrl(bvUrls.getByPath(paths.isDisconnected), params)
        },
        getIsSessionDisconnectionEnabledUrl:function(params){
            return bvUrls.buildUrl(bvUrls.getByPath(paths.isSessionDisconnectionEnabled), params);
        },
        getIsPossibleToLoginUrl: function(params){
            return bvUrls.buildUrl(bvUrls.getByPath(paths.isPossibleToLogin), params)
        },
        getLoginInternal: function (params){
            return bvUrls.buildUrl(bvUrls.getByPath(paths.loginInternal), params);
        },
        getValidateSecurityPolicy: function (params) {
            return bvUrls.buildUrl(bvUrls.getByPath(paths.validateSecurityPolicy), params);
        },
        getInfoForSignPendingEds: function (params) {
            return bvUrls.buildUrl(bvUrls.getByPath(paths.infoForSignPendingEds), params);
        },
        getCheckEds: function (params) {
            return bvUrls.buildUrl(bvUrls.getByPath(paths.checkEds), params);
        },
        getEdsCanceled: function (params) {
            return bvUrls.buildUrl(bvUrls.getByPath(paths.edsCanceled), params);
        },
        getEdsExceededAttempts: function (params) {
            return bvUrls.buildUrl(bvUrls.getByPath(paths.edsExceededAttempts), params);
        },
        getEdsNCALayerClosed: function (params) {
            return bvUrls.buildUrl(bvUrls.getByPath(paths.edsNCALayerClosed), params);
        },
        getDisconnectedUrl: function (params) {
            return bvUrls.buildUrl(bvUrls.getByPath(paths.disconnected), params)
        },
        ...
        getDisconnectAllSessionsUrl:function (params){
            return bvUrls.buildUrl(bvUrls.getByPath(paths.disconnectAllSessions), params);
        },
