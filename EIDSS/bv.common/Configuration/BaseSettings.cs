...
namespace bv.common.Configuration
{
    public class SettingName
    {
        ...
        public static string GgPinServiceBaseUrl = "GgPinServiceBaseUrl";
        ...
        public const string CryptAlgorithmMode = "CryptAlgorithmMode";
    }
    public class BaseSettings
    {
        ...
        public static CryptorAlgorithm DefaultCryptAlgorithmMode
        {
            get { return _defaultCryptAlgorithmMode; }
        }

        public static CryptorAlgorithm CryptAlgorithmMode
        {
            get
            {
                var strCryptAlgorithmMode = Config.GetSetting(SettingName.CryptAlgorithmMode, _defaultCryptAlgorithmMode.ToString());
                CryptorAlgorithm cryptorAlgorithmMode = _defaultCryptAlgorithmMode;
                if (Enum.TryParse<CryptorAlgorithm>(strCryptAlgorithmMode, out cryptorAlgorithmMode))
                {
                    return cryptorAlgorithmMode;
                }
                return _defaultCryptAlgorithmMode;
            }
        }
        ...
        public static string GgPinServiceBaseUrl
        {
            get 
            {
                var baseUrl = Config.GetSetting(SettingName.GgPinServiceBaseUrl, "");
                return baseUrl != null ? baseUrl.TrimEnd('/') : string.Empty;
            }
        }
