...
Public Class SecurityPolicyDetail
    ...
    Protected Overrides Sub DefineBinding()
        ...
        Me.chkDisableParallelSessions.DataBindings.Add("EditValue", table, "intDisableParallelSessions")

        Me.chkPasswordComplexity.Enabled = SecurityPolicy_DB.PasswordExpression(baseDataSet).Length > 0

        If (Not table Is Nothing) AndAlso table.Columns.Contains("strPwdComplexityDescription") AndAlso _
           (table.Rows.Count > 0) Then

            Dim pwdComplexityDesc As String = table.Rows(0)("strPwdComplexityDescription").ToString()
            If Not String.IsNullOrEmpty(pwdComplexityDesc) Then
                Me.txtDescription.Text = pwdComplexityDesc.Replace("&", "&&")
            End If
        End If
