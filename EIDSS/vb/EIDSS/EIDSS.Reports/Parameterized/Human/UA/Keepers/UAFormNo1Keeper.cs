...
{
    public partial class UAFormNo1Keeper : BaseDateKeeper
    {
        internal UAFormNo1Keeper()
        {
            ReportType = typeof(FormNum1);
        ...
        protected override BaseReport GenerateReport(
            DbManagerProxy manager, DbManagerProxy archiveManager)
        {
            ...
            FormNum1 report = (FormNum1)CreateReportObject();
