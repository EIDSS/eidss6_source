...
namespace EIDSS.Reports.BaseControls.Filters
{
    public sealed partial class ThaiCaseClassificationFilter : BaseLookupFilter
    {
        ...
        protected override DataView CreateDataSource()
        {
            ...
            view.RowFilter = @"blnIsHuman = 1";//Filter for UA Covid-19 Report//TODO: Remove as obsolete for TH report//@"blnIsHuman = 1 and (blnInitialHumanCaseClassification = 1 or blnFinalHumanCaseClassification = 1)";
            view.Sort = "name";
            return view;
        }
