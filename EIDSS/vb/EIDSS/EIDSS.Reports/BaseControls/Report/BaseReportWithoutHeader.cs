...
//    {
//        XtraReport ThisReport { get; }

//        XtraReport ChildReport { get; set; }
//    }

//    public partial class BaseReportWithoutHeader : XtraReport, IBaseReport
//    {
//        private ReportRebinder m_ReportRebinder;
//        protected ClsBarCode m_BarCode = new ClsBarCode();

//        public BaseReportWithoutHeader()
//        {
...
//                    fillTableAction((SqlConnection)manager.Connection, (SqlTransaction) manager.Connection.BeginTransaction(IsolationLevel.ReadUncommitted));
//                    break;
