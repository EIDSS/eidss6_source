...
namespace EIDSS.Reports.Factory
{
    public class ReportRtlHelper : RtlHelper
    {
        ...
        private static void ApplyRTL(XRControl parentControl, int? originalWidth = null)
        {
            ...
            if (subreport != null)
            {
                var originalReport = subreport.Report.Report as XtraReport;
                if (originalReport != null)
                    originalWidth = originalReport.PageWidth;

                ApplyRTL(subreport.ReportSource, originalWidth);
                ...
                if (band != null)
                {
                    ...
                    if (report != null)
                    {
                        if (originalWidth != null)
                            report.PageWidth = report.PageWidth > originalWidth.Value ? originalWidth.Value : report.PageWidth;
