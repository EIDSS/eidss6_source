...
Public Class PaperFormsLoader
    ...
    Private Shared Function IsPaperFormVisible(ByVal fileName As String) As Boolean
        ...
        Else
            ...
            End If
        End If
        If EidssSiteContext.Instance.IsJordanMoACustomization And ModelUserContext.CurrentLanguage = Localizer.lngEn Then
            If fileName.Contains("Investigation Form For Avian Disease Outbreaks.pdf") Then
                Return False
            End If
            If fileName.Contains("Investigation Form For Livestock Disease Outbreaks.pdf") Then
            ...
            End If
        Else
            If fileName.Contains("Investigation Form For Avian Disease Outbreaks JO.pdf") Then
                Return False
            End If
            If fileName.Contains("Investigation Form For Livestock Disease Outbreaks JO.pdf") Then
                Return False
            End If
        End If
        Return True
    ...
    Private Shared Function GetPaperFormName(ByVal fileName As String) As String
        ...
        If fileName.Contains("Investigation Form For Avian Disease Outbreaks JO") Then
            Return EidssMessages.Get("msgAvianCaseForm")
        End If
        ...
        If fileName.Contains("Investigation Form For Livestock Disease Outbreaks JO") Then
            Return EidssMessages.Get("msgLivestockCaseForm")
        End If
