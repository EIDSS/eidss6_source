...
#Region " Windows Form Designer generated code "
    ...
    Private Sub InitializeComponent()
        ...
        'cmReports
        '
        If eidss.model.Reports.BaseMenuReportRegistrator.IsPaperFormAllowed("VetLivestockInvestigation") Then
            Me.cmReports.MenuItems.Add(Me.MenuItem1)
        End If
        If eidss.model.Reports.BaseMenuReportRegistrator.IsPaperFormAllowed("VetUrgentNotificationJo") Then
            Me.cmReports.MenuItems.Add(Me.miUrgentNotificationReportJo)
        End If
