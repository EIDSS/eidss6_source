namespace EidssConfigEditor
{
  ...
  public partial class MainForm : Form
  {
    ...
    private const string CryptAlgorithmMode = "CryptAlgorithmMode";
    private const CryptorAlgorithm _defaultCryptAlgorithmMode = CryptorAlgorithm.Rijndael;
    ...
    private CryptorAlgorithm m_cryptorAlgorithmMode = CryptorAlgorithm.Rijndael;
    ...
    private void InitCryptAlorithm()
    {
        var strCryptAlgorithmMode = m_config.GetItem(CryptAlgorithmMode);
        CryptorAlgorithm cryptorAlgorithmMode = _defaultCryptAlgorithmMode;
        if ((!string.IsNullOrEmpty(strCryptAlgorithmMode)) && Enum.TryParse<CryptorAlgorithm>(strCryptAlgorithmMode, out cryptorAlgorithmMode))
        {
            m_cryptorAlgorithmMode = cryptorAlgorithmMode;
        }
        m_cryptorAlgorithmMode = _defaultCryptAlgorithmMode;
    }
    ...
    private void InitArchiveDbFields()
    {
      ...
      try
      {
        ...
        {
            txtArchiveUser.Text = Cryptor.Decrypt(txtArchiveUser.Text, m_cryptorAlgorithmMode);
        }
        if (!string.IsNullOrEmpty(txtArchivePassword.Text) && !string.IsNullOrEmpty(txtArchiveUser.Text))
        {
            txtArchivePassword.Text = Cryptor.Decrypt(txtArchivePassword.Text, txtArchiveUser.Text, m_cryptorAlgorithmMode);
        }
      }
      catch (Exception)
      {
    ...
    private void InitSqlDbFields()
    {
      ...
      try
      {
        ...
        {
            txtSQLUser.Text = Cryptor.Decrypt(txtSQLUser.Text, m_cryptorAlgorithmMode);
        }
        if (!string.IsNullOrEmpty(txtSQLPassword.Text) && !string.IsNullOrEmpty(txtSQLUser.Text))
        {
            txtSQLPassword.Text = Cryptor.Decrypt(txtSQLPassword.Text, txtSQLUser.Text, m_cryptorAlgorithmMode);
        }
      }
      catch (Exception)
      {
    ...
    private void InitDbForAvrFields()
    {
      ...
      try
      {
        ...
        {
            txtSQLUserForAvr.Text = Cryptor.Decrypt(txtSQLUserForAvr.Text, m_cryptorAlgorithmMode);
        }
        if (!string.IsNullOrEmpty(txtSQLPasswordForAvr.Text) && !string.IsNullOrEmpty(txtSQLUserForAvr.Text))
        {
            txtSQLPasswordForAvr.Text = Cryptor.Decrypt(txtSQLPasswordForAvr.Text, txtSQLUserForAvr.Text, m_cryptorAlgorithmMode);
        }
      }
      catch (Exception)
      {
    ...
    private void SaveArchiveConnection()
    {
      ...
      else
      {
        ...
        m_config.SetItem(ArchiveUser, Cryptor.Encrypt(txtArchiveUser.Text, m_cryptorAlgorithmMode));
        m_config.SetItem(ArchivePassword, Cryptor.Encrypt(txtArchivePassword.Text, txtArchiveUser.Text, m_cryptorAlgorithmMode));
      }
    }
    ...
    private void SaveDbConnection()
    {
      ...
      m_config.SetItem(SqlUser, Cryptor.Encrypt(txtSQLUser.Text, m_cryptorAlgorithmMode));
      m_config.SetItem(SqlPassword, Cryptor.Encrypt(txtSQLPassword.Text, txtSQLUser.Text, m_cryptorAlgorithmMode));
    }
    ...
    private void SaveDbConnectionForAvr()
    {
      ...
      m_config.SetItem(AvrUser, Cryptor.Encrypt(txtSQLUserForAvr.Text, m_cryptorAlgorithmMode));
      m_config.SetItem(AvrPassword, Cryptor.Encrypt(txtSQLPasswordForAvr.Text, txtSQLUserForAvr.Text, m_cryptorAlgorithmMode));
    }
